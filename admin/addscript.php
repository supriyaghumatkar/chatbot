...
<div class="container">
    <h2>Make Your Own Script</h2>
    <div class="col-sm-12"> 
       
  <form class="form-inline" method="POST" action="#" id="myform">
        <div class="col-sm-6"> 
    <div class="form-group col-sm-8">
        <button type="button"  class="btn btn-default find_type col-sm-6"  id="text_ques" value="text_question">Text</button>
    </div>
    <div class="form-group col-sm-8">
      <button  type="button" class="btn btn-default find_type col-sm-6" id="statement" value="statement">Statement</button>
    </div>
    <div class="form-group col-sm-8">
      <button type="button" class="btn btn-default find_type col-sm-6" id="dropdown" value="dropdown">Dropdown</button>
    </div>
   <div class="form-group col-sm-8">
      <button type="button"  class="btn btn-default find_type col-sm-6" id="multiselect" value="multiselect">Multiselect</button>
    </div>
      <div class="form-group col-sm-8">
      <button type="button" class="btn btn-default find_type col-sm-6" id="email_type" value="email_type">Email</button>
    </div>
